...
public class LogbackConfig {
	...
	public PatternLayoutEncoder logBackencoder() {
		PatternLayoutEncoder logBackencoder = new PatternLayoutEncoder();
		logBackencoder.setContext(loggerContext() );
		logBackencoder.setPattern(env.getRequiredProperty(LOGBACK_ENCODER_PATTERN));
	...
	public ConsoleAppender consoleAppender() {
		...
		appender.setEncoder( logBackencoder());
		appender.start();
		return appender;
	}
	...
	public  FileAppender fileAppender() {
		...
		fileAppender.setEncoder(logBackencoder());
