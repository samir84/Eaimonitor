...
// fcViews.views.list = ListView;
 
   fcViews.ListView = View.extend({ // make a subclass of View
                ...
                for (var i = eventsCopy.length - 1; i >= 0; --i) {
                    ...
                    if (currentDayStart.isAfter(eventEnd) || (currentDayStart.isSame(eventEnd) && !eventStart.isSame(eventEnd)) || periodEnd.isBefore(eventStart)) {
                        ...
                        <tr class="fc-row fc-event-container fc-content">\
                            <td class="fc-time">' + (e.allDay ? this.opt('allDayText') : e.start.format('H:mm') + '-' ) + '</td>\
                            <td>\
   ...
   //My Custom View
   //fcViews.ListView = View.extend
      // var CustomView;          // our subclass
 
    fcViews.CustomView =  View.extend({
        ...
        render: function () {
            ...
            //this.dayGrid.addElement(this.el.find('.fc-day-grid'));
        ...
        numberCellHtml: function (cell) {
            ...
            if (!this.dayNumbersVisible) { // if there are week numbers but not day numbers
                return '<td/>';// will create an empty space above eventsðŸ˜¦
            }
        ...
        setGridHeight: function (height, isAuto) {
            if (isAuto) {
				...
				//console.log("this.dayGrid.rowEls:"+this.dayGrid.rowEls);
                //distributeHeight(this.dayGrid.rowEls, height, true); // true = compensate for height-hogging rows
            }
        },
            ...
            while (currentDayStart.isBefore(periodEnd)) {
                ...
                for (var i = eventsCopy.length - 1; i >= 0; --i) {
                    ...
                    if (currentDayStart.isAfter(eventEnd) || (currentDayStart.isSame(eventEnd) && !eventStart.isSame(eventEnd)) || periodEnd.isBefore(eventStart)) {
                        ...
                        if (!didAddDayHeader) {
                            tbody.append('\
                                <li class="list-group-item my-fc-header" date="">\
                                    <span class="my-fc-header-day">' + currentDayStart.format('dddd') + '</span>\
                                    <span class="my-fc-header-date">' + currentDayStart.format('YYYY-MM-DD') + '</span>\
                                </li>');
                        ...
                        var segEl = $('\
							...
							<div class="row">\
                        		...
                        		<strong>'+e.project.projectName+'</strong>\
                        		 </div>\
								<div class="col-md-3" activity="'+e.activity.id+'"><strong>'+e.activity.activityName+'</strong></div>\
								<div class="col-md-3 "><span class="info-box-number">'+e.hours+'</span></div>\
								<div class="action-buttons">\
                                <a style="cursor: pointer;" ><span id ="edit" class="glyphicon glyphicon-pencil"></span></a>\
                                <a style="cursor: pointer;"   class="trash" id="'+e.id+'"><span id="trash" class="glyphicon glyphicon-trash"></span></a>\
                                <a  class="flag"><span class="glyphicon glyphicon-flag"></span></a>\
                            </div>\
							</li>'
							);
                        tbody.append(segEl);
                ...
                var totalWorked=$('\
						...
						<div class="col-md-3 ">Total: <span class="info-box-number">'+totalHours+'</span>\
						</div>'
                );
                this.el.append(totalWorked);
                currentDayStart.add(1, 'days');
            }
