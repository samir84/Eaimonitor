			...
			<section class="col-lg-6 connectedSortable">
				...
				<div class="nav-tabs-custom">
					...
					<ul class="nav nav-tabs pull-right">
						...
						<li class="active"><a href="#orders-chart" data-toggle="tab">Donut</a></li>
						<li class="pull-left header"><i class="fa fa-inbox"></i>Orders</li>
					</ul>
					<div class="tab-content no-padding">
						<!-- Morris chart - Orders -->
						<!-- <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;"></div> -->
						<div class="chart tab-pane active" id="orders-chart"
				...
				<div class="box box-success">
					...
					<div class="box-body chat" id="chat-box">
						<!-- chat item -->
						<div class="item">
							<img src="${resourceUrl}/dist/img/user4-128x128.jpg" alt="user image"
								class="online">
						...
						<!-- chat item -->
						<div class="item">
							<img src="${ resourceUrl}/dist/img/user3-128x128.jpg" alt="user image"
								class="offline">
						...
						<!-- chat item -->
						<div class="item">
							<img src="${resourceUrl}/dist/img/user2-160x160.jpg" alt="user image"
								class="offline">
			...
			<section class="col-lg-6 connectedSortable">
				...
				<div class="box box-solid">
            		<div class="box-header with-border">
            			<i class="fa fa-th"></i>
						<h3 class="box-title">Job Status Report</h3>
            		</div>
            		<div class="box-body border-radius-none">
		  						<div id="job-stackedColumn"></div>
            		</div>
